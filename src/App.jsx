...
import DoctorWalkinReview from './pages/doctor/DoctorWalkinReview.jsx'
  ...
  return (
    <ErrorBoundary>
      <Routes>
        ...
        <Route path="/doctor/walkin/:id/review" element={<DoctorRoute><DoctorWalkinReview /></DoctorRoute>} />
